...
@implementation FMXWebViewProgressView
...
-(void)configureViews
{
    ...
    UIColor *tintColor = [UIColor colorWithRed:29.0/255.0 green:204.0/255.0 blue:254.0/255.0 alpha:1.0]; // iOS7 Safari bar color
    if ([UIApplication.sharedApplication.delegate.window respondsToSelector:@selector(setTintColor:)] && UIApplication.sharedApplication.delegate.window.tintColor) {
        tintColor = [UIColor colorWithRed:29.0/255.0 green:204.0/255.0 blue:254.0/255.0 alpha:1.0];//UIApplication.sharedApplication.delegate.window.tintColor;
    }
